...
export function detectionItem(detectionItems) {
    if (detectionItems) {
     ...
     <div class="config-item-main-container">
       ...
       <div class="config-item-title-row flex `+ (detectionItem.bookingsheet === "AmagProTime" ? null : "dNone") + `">
         <p class="subtext subtext-top">Buchung</p>
       </div>
       <div class="project-detection-item--amagprotime `+ (detectionItem.bookingsheet === "AmagProTime" ? null : "dNone") + `">
          <div>
