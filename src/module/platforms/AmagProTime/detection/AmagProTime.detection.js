  ...
  return (
    ...
    <div class="configItem-content-row dFlex">
      <div class="detectionItem-content-smaller">
        <input type="text" class="input-size--large ${detectionObj.bookingsheet ? '' : 'dNone'}" name="input_ticketPrefix" id="input_ticketPrefix${detectionObj.id}" placeholder="WCS" value="${ detectionObj.ticketprefix }" title="Teil der Ticketnummer, Prefixes oder des Namens, der immer konstant bleibt. (Bsp.: RELAUNCHAM)"/>
      </div>
    ...
    <div class="project-detectionItem--amagprotime">
      <div class="configItem-content-row dFlex">
        <div class="detectionItem-content-larger">
          <select name="select_protimeservice" id="select_protimeservice-${detectionObj.id }" title="Wähle den Service aus, unter welchen du buchen willst.">
      ...
      <div class="configItem-content-row dFlex">
        <div class="configItem-content-fullWidth">
          <input type="text" class="input-size--large" name="input_protimeactivity" id="input_protimeactivity-${detectionObj.id}" list="datalist_activity${detectionObj.id}" placeholder="Aktivität (Wenn vorhanden)" title="Bei zusätzlichen Aktivitäts-Felder, kannst du hier eine Auswahl oder Eingabe treffen."/>
          <datalist id="datalist_activity${detectionObj.id}">
            <option>ART Team Events</option>
      ...
      <div class="configItem-content-row dFlex">
        <div class="configItem-content-fullWidth">
          <input type="text" class="input-size--large" name="input_protimeaddtext" id="input_protimeaddtext-${detectionObj.id}" placeholder="Zusatztext für die Beschreibung" title="Der hier reingeschriebene Text wird immer zusätzlich an deiner Ticketbeschreibung angehängt und in das Text-Feld in ProTime geschrieben (Optional)"/>
        </div>
      </div>
    </div>`
  )
